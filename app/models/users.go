...
func (u *Users) UpdateUser() (err error) {
...
func (u *Users) DeleteUser() (err error) {
...
func (u *Users) CreateSession() (session Session, err error) {
	session = Session{}
...
func (sess *Session) GetUserBySession() (user Users, err error) {
	user = Users{}
	cmd := `select id, uuid, name, email, password, created_at
	from users where id = ?`
